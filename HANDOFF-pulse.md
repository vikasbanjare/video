...
Current version: **v0.9.363** (`CutPilot/index.html`, `CutPilot/CSXS/manifest.xml`).
...
### v0.9.350 → v0.9.363 (this session) — preview/render fidelity
...
1. **Get v0.9.363 confirmed on the owner's machine** — nothing after v0.9.339 has been
