...
Current version: **v0.9.364** (`CutPilot/index.html`, `CutPilot/CSXS/manifest.xml`).
...
### v0.9.350 → v0.9.364 (this session) — preview/render fidelity
...
1. **Get v0.9.364 confirmed on the owner's machine** — nothing after v0.9.339 has been
